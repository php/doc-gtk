...
<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.recto">
    
  <xsl:choose xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:when xmlns:xsl="http://www.w3.org/1999/XSL/Transform" test="setinfo/title">
      <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/title[1]"/>
    </xsl:when>
    <xsl:when xmlns:xsl="http://www.w3.org/1999/XSL/Transform" test="title">
      <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="title[1]"/>
    </xsl:when>
  </xsl:choose>

    
  <xsl:choose xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:when xmlns:xsl="http://www.w3.org/1999/XSL/Transform" test="setinfo/subtitle">
      <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/subtitle[1]"/>
    </xsl:when>
    <xsl:when xmlns:xsl="http://www.w3.org/1999/XSL/Transform" test="subtitle">
      <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="subtitle[1]"/>
    </xsl:when>
  </xsl:choose>

    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/corpauthor"/>
    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/authorgroup"/>
    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/author"/>
    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/copyright"/>
    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/legalnotice"/>
    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/pubdate"/>
    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/revision"/>
    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/revhistory"/>
    
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" mode="set.titlepage.recto.auto.mode" select="setinfo/abstract"/>
...
<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.verso">
...
<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.separator">
    <hr/>
...
<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.before.recto">
  
</xsl:template>

  

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.before.verso">
  
</xsl:template>


<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage">
  <div class="titlepage">
    <xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.before.recto"/>
    <xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.recto"/>
    <xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.before.verso"/>
    <xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.verso"/>
    <xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="set.titlepage.separator"/>
  </div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="*" mode="set.titlepage.recto.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="*" mode="set.titlepage.verso.mode">
  <!-- if an element isn't found in this mode, -->
  <!-- try the generic titlepage.mode -->
  <xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="titlepage.mode"/>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="title" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="subtitle" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="corpauthor" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="authorgroup" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="author" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="copyright" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="legalnotice" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="pubdate" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="revision" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="revhistory" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>

<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" match="abstract" mode="set.titlepage.recto.auto.mode">
<div use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<div use-attribute-sets="part.titlepage.recto.style">
...
<div use-attribute-sets="partintro.titlepage.recto.style">
...
<div use-attribute-sets="reference.titlepage.recto.style">
...
<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="dedication.titlepage.recto">
  ...
  <div use-attribute-sets="dedication.titlepage.recto.style">
...
<div use-attribute-sets="preface.titlepage.recto.style">
...
<div use-attribute-sets="chapter.titlepage.recto.style">
...
<div use-attribute-sets="appendix.titlepage.recto.style">
...
<div use-attribute-sets="section.titlepage.recto.style">
...
<div use-attribute-sets="sect1.titlepage.recto.style">
...
<div use-attribute-sets="sect2.titlepage.recto.style">
...
<div use-attribute-sets="sect3.titlepage.recto.style">
...
<div use-attribute-sets="sect4.titlepage.recto.style">
...
<div use-attribute-sets="sect5.titlepage.recto.style">
...
<div use-attribute-sets="simplesect.titlepage.recto.style">
...
<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="bibliography.titlepage.recto">
  ...
  <div use-attribute-sets="bibliography.titlepage.recto.style">
<xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="component.title">
...
<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="glossary.titlepage.recto">
  ...
  <div use-attribute-sets="glossary.titlepage.recto.style">
<xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="component.title">
...
<xsl:template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="index.titlepage.recto">
  ...
  <div use-attribute-sets="index.titlepage.recto.style">
<xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="component.title">
