...
<!-- ********************************************************************
     $Id: param.xsl,v 1.1 2003-05-02 17:18:13 sfox Exp $
     ********************************************************************
...
<xsl:param name="admon.style" doc:type='string'>
  <xsl:text>margin-left: 24px; margin-right: 24px; font-weight: bold;</xsl:text>
</xsl:param>
...
<!-- ==================================================================== -->
<xsl:param name="check.idref" doc:type='boolean'>0</xsl:param>
