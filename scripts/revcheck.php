...
<html>
<head>
<title>PHP-GTK Revision-check</title>
...
<tr><td><h2 class=c>Status of the translated PHP-GTK Manual</h2><p class=c style="font-size:12px;">Generated: {$date} &nbsp; / &nbsp; Language: $LANG<br></p></td></tr>
</table>
</td></tr>
</table>
END_OF_MULTILINE;
...
if ($count > 0) {
    ...
    foreach($missing_files as $file => $info) {
        ...
        print "<tr class=wip><td><a href=\"http://cvs.php.net/viewcvs.cgi/php-gtk-doc/manual/en/$file?view=markup\">$short_file</a></td>" .
